...
\begin{tablist}
\item[2026] \tab{}\enquote{Posthumous Harm via Speculative Mis-Remembering: A Comparative Analysis of Generative AI Avatars} at the \nth{20} meeting of \textit{philo}SOPHIA: a feminist society. Philadelphia. April 18.
    \item[2025] \tab{}\enquote{Interpreting Our World Through Datasets: Large Language Models and Epistemic Harms} at the \nth{2} Annual Susanne E. Foster Graduate Philosophy Conference on AI Ethics and Society. Marquette University, Milwaukee. April 5, 2025.
    \item[2024] \tab{}\enquote{Analyzing the Bootstrapping Problem of Web3: A Tri-Conditional Approach} at the \nth{33} Annual Association for Practical and Professional Ethics International Conference. Cincinnati. February 24, 2024. [Joint presentation with Violet Victoria].
