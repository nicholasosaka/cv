...
\begin{itemize}[label={--}, leftmargin=1em]
    \setlength\itemsep{0em}
    \item Leading disaster recovery initative (testing and internal certification) for our big data platform ecosystem (Amazon EMR and EC2).
...
\begin{itemize}[label={--}, leftmargin=1em]
    \setlength\itemsep{0em}
    \item Collaborated in implementing an Enterprise Data Services-wide Financial Operations Analytics System, which tracks over \$5M of cloud spend across 1,200 departments at 1/1000th of a dollar level accuracy per year.
